...
const DEMO_DATA = [
  {
    ...
    img: HIW1img,
    imgDark: HIW1img,
    title: "ค้นหาและเลือกซื้อ",
    desc: "ค้นหาหรือเลือกซื้อสินค้าด้วยระบบแนะนำสินค้าที่คุณลูกค้าต้องการซื้อ",
  },
  {
    id: 2,
    img: HIW2img,
    imgDark: HIW2img,
    title: "เพิ่มลงรถเข็น",
    desc: "เลือกรายการที่ต้องการซื้อและเพิ่มลงในรถเข็นได้อย่างง่ายดาย",
  },
  {
    id: 3,
    img: HIW3img,
    imgDark: HIW3img,
    title: "รอจัดส่ง",
    desc: "ผู้ให้บริการจะยืนยันและจัดส่งถึงคุณอย่างรวดเร็ว",
  },
  {
    id: 4,
    img: HIW4img,
    imgDark: HIW4img,
    title: "ได้รับสินค้าเรียบร้อย",
    desc: "ขอให้สนุกและเพลิดเพลินกับสินค้าคุณภาพระดับ 5 ดาวของคุณ",
  },
];
