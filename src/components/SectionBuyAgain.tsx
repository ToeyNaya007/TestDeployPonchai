...
const SectionBuyAgain: React.FC = () => {
    ...
    useEffect(() => {
        if (products.length > 0) {
            glideRef.current = new Glide(".glide-buy-again", {
                type: "slider",
                startAt: 0,
    ...
    return (
        <div className="relative py-8">
            <div className="flex flex-row items-center justify-between border-b-8 border-blue-700">
                <p className="text-xl md:text-3xl font-bold mb-2 pl-4">ซื้ออีกครั้ง</p>
                <a href="#" className="text-gray-500 text-lg text-right mb-2 pr-10">
                    ดูเพิ่มเติม...
                </a>
            </div>

            <div className="glide-buy-again pt-4 relative">
...
export default SectionBuyAgain;
