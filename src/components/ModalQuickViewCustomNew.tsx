...
import ProductQuickView from "./ProductQuickViewNew";
...
const ModalQuickViewCustom: FC<ModalQuickViewProps> = ({
  show,
  ...
  return (
    ...
    >
      <div className="flex items-stretch md:items-center justify-center h-full text-center md:px-4">
        ...
        >
          <div className="pt-4 relative inline-flex xl:py-8 w-full max-w-5xl max-h-full">
            <div
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto rounded-xl hiddenScrollbar">
                  <ProductQuickView product={product} onClose={onCloseModalQuickView} />
              </div>
            </div>
          </div>
        </Transition.Child>
...
export default ModalQuickViewCustom;