        ...
        <div className="p-6 flex flex-col sm:flex-row items-start">
          ...
          <div className="sm:ml-8">
            <h3 className=" text-slate-700 dark:text-slate-300 flex ">
              <span className="uppercase">ที่อยู่สำหรับจัดส่ง</span>
              <svg
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth="2.5"
        ...
        >
          ...
          <div className="sm:flex space-y-4 sm:space-y-0 sm:space-x-3">
            <div className="flex-1">
              <Label className="text-sm">รายละเอียดที่อยู่</Label>
              <Input
                className="mt-1.5"
                placeholder=""
            ...
            <div className="sm:w-1/3">
              <Label className="text-sm">ชั้น,ตึก *</Label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-3">
            <div>
              <Label className="text-sm">จัดหวัด</Label>
          ...
          {/* ============ */}
          <div>
            <Label className="text-sm">ประเภทที่อยู่</Label>
            <div className="mt-1.5 grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
              <Radio
                label={`<span class="text-sm font-medium">บ้าน <span class="font-light">(จัดส่งทั้งวัน)</span></span>`}
                id="Address-type-home"
                name="Address-type"
                defaultChecked
              />
              <Radio
                label={`<span class="text-sm font-medium">ที่ทำงาน <span class="font-light">(ส่งแค่ช่วงเวลา <span class="font-medium">9 AM - 5 PM</span>)</span> </span>`}
